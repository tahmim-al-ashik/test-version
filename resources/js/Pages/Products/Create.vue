<template>
    <AuthenticatedLayout>
        ...
        <CategoryModal v-if="showCategoryModal" @categoryAdded="handleCategoryAdded" @close="showCategoryModal = false"/>
        <SubcategoryModal v-if="showSubcategoryModal" @subcategoryAdded="handleSubcategoryAdded" @close="showSubcategoryModal = false"/>
    </AuthenticatedLayout>
</template>
