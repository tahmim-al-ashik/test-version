<template>
    <AuthenticatedLayout>
        ...
        <div class="container">
            ...
            <main class="edit-customer-container">
                <form @submit.prevent="submit">
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label for="customer_no">Customer No</label>
                            <input type="text" v-model="form.customer_no" disabled>
                        </div>
                        <div>
...
const form = ref({
    ...
    personal_id: props.customer.personal_id,
    address: props.customer.address,
    postcode: props.customer.postcode,
    city: props.customer.city,
    gln: props.customer.gln,
    vat_no: props.customer.vat_no,
    phone_no: props.customer.phone_no,
    mobile_no: props.customer.mobile_no,
    email_invoice: props.customer.email_invoice,
    email_cc: props.customer.email_cc,
    website: props.customer.website,
    country_id: props.customer.country_id,
    language_id: props.customer.language_id,
    currency_id: props.customer.currency_id,
    references: props.customer.references || [],
    delivery_requirements: props.customer.delivery_requirements || [],
    payment_requirements: props.customer.payment_requirements || []
});
...
function submit() {
    router.post(route('customers.update', { customer: form.value.id }), form.value).then(() => {
